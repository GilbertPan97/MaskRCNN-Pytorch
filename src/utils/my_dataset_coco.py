...
from src.utils.coco_utils import coco_remove_images_without_annotations, convert_coco_poly_mask
...
class CocoDetection(data.Dataset):
    ...
    def __init__(self, root, dataset="train", transforms=None, years="2017"):
        ...
        self.img_root = os.path.join(root, f"images")
        ...
        if dataset == "train":
            ...
            with open("./record/coco_class_idx.json", "w") as f:
                f.write(json_str)
