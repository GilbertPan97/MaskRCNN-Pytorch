...
import torch
import src.utils.distributed_utils as utils
from src.utils.coco_eval import EvalCOCOMetric
...
def evaluate(model, data_loader, device):
    ...
    det_metric = EvalCOCOMetric(data_loader.dataset.coco,
                                iou_type="bbox",
                                results_file_name="./record/det_results.json")
    seg_metric = EvalCOCOMetric(data_loader.dataset.coco,
                                iou_type="segm",
                                results_file_name="./record/seg_results.json")
